...
export CC=/usr/dnta/kull/developers/thirdPartySoftware/Linux/clang-3.6.1/bin/clang
export CXX=/usr/dnta/kull/developers/thirdPartySoftware/Linux/clang-3.6.1/bin/clang++
export F77=gfortran
export F90=gfortran
